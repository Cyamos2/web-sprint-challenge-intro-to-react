...
React JS is a system that is used for building user interfaces/UI components. It originated from Facebook and a community of individual developers and companies. It is used as a base in the development of a single-page or mobile applications.

1. Describe component state.
They are states where you store property values that belongs in the component.

1. Describe props.
They are properties and is used for passing data from one component to another. They are however passed in a uni-directional flow.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
It is a concept about behaviours of functions. You use an effect hook to perform side effects in function components.
